...
########## Modifs Apportées ##################################################################
  Force_get=chipy.poroMAILx_GetBodyVector('Fext_', 1)
  print("get sahpe= ", Force_get.shape)
  Force_put=np.zeros(Force_get.shape)
  Force_put[4,2]=1.0
  chipy.poroMAILx_PutBodyVector('Fext_', 1,Force_put)
########## Fin Modifs ########################################################################
