...
Porous = pre.model(name='Poro_', physics='POROx', element='H208x',\
                   ...
                   material='elas_', anisotropy='iso__', dimension=dim, \
                   mass_storage='lump_',\
                   capacity_storage='lump_',\
                   physical_type = 'solid',\
                   convection_type = 'char_')
...
# boundary conditions:
conc.imposeDrivenDof(group='160', component=[1,2] , dofty='vlocy')

conc.imposeDrivenDof(group='161', component=[1,2,4] , dofty='vlocy')
