...
Model_Thermique = pre.model(name='DIFFU',                           # Key to find the model 
                            ...
                            formulation = 'class',
                            external_fields = ['COCO','SPHV','SECTION'])
...
Mailx = pre.readMesh('MESH/Reseau3D_decimate_80.msh', dim=dimension, keep_elements=[1])
...
Barre3D.imposeDrivenDof(group='28', component = 1, dofty='temp', ct = 100.0, rampi = 1.0)
# ------------------------------------------------------
