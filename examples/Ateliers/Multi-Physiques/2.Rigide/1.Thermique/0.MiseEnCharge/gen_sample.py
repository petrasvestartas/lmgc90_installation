...
tdur = material(name='TDURx',materialType='RIGID',density=78000.)
...
radii=granulo_Random(nb_particles, 0.45, 0.55)
...
up.imposeDrivenDof(component=[2], dofty='force',ct=-1000.,ramp=5000)
...
#       - entre particules
ldkdk=tact_behav(name='iqsc0',law='IQS_CLB',fric=0.0)
tacts+=ldkdk

#       - avec les parois
ldkjc=tact_behav(name='iqsc1',law='IQS_CLB',fric=0.0)
tacts+=ldkjc
