...
down2= rigidPlan(axe1=R_cyl, axe2=R_cyl, axe3=r_min, center=[0., 0., -r_min], model=mod, material=tdur, color='MWALL')
up2  = rigidPlan(axe1=R_cyl, axe2=R_cyl, axe3=r_min, center=[0., 0., H_cyl+r_min], model=mod, material=tdur, color='MWALL')

down2.imposeDrivenDof(component=[1,2,4,5,6], dofty='vlocy')
down2.imposeDrivenDof(component=[3], dofty='vlocy', ct=vimp)

up2.imposeDrivenDof(component=[1,2,4,5,6], dofty='vlocy')
up2.imposeDrivenDof(component=[3], dofty='vlocy', ct=-vimp)

up2.rotate(theta=np.pi, center=up.nodes[1].coor)

bodies.addAvatar(down2)
bodies.addAvatar(up2)

cylu = rigidCylinder(R_cyl,r_max,[0.,0.,H_cyl-r_max], mod, tdur, color='MWALL', is_Hollow=True)
cyld = rigidCylinder(R_cyl,r_max,[0.,0.,r_max]      , mod, tdur, color='MWALL', is_Hollow=True)
cylu.imposeDrivenDof(component=[1,2,4,5,6], dofty='vlocy')
cylu.imposeDrivenDof(component=[3], dofty='vlocy', ct=-vimp)
cyld.imposeDrivenDof(component=[1,2,4,5,6], dofty='vlocy')
cyld.imposeDrivenDof(component=[3], dofty='vlocy', ct=vimp)

bodies.addAvatar(cylu)
bodies.addAvatar(cyld)
...
svsppl2= see_table(CorpsCandidat   ='RBDY3', candidat   ='SPHER', colorCandidat   ='BILLE',behav=lspwl, 
                   CorpsAntagoniste='RBDY3', antagoniste='PLANx', colorAntagoniste='MWALL',alert=0.1*r_min)
svs+=svsppl2
svspdc = see_table(CorpsCandidat   ='RBDY3', candidat   ='SPHER', colorCandidat   ='BILLE',behav=lspwl, 
                   CorpsAntagoniste='RBDY3', antagoniste='DNLYC', colorAntagoniste='MWALL',alert=0.1*r_min)
svs+=svspdc
