...
def write_gp_joint(fid,k,all):
  ...
  fielddef=[ ('n' , False, 3, lambda i: all[i,3:6],),
              ('et', False, 1, lambda i: all[i,6],),
              ('es', False, 1, lambda i: all[i,7],),
              ('en', False, 1, lambda i: all[i,8],),
              ('st', False, 1, lambda i: all[i,9],),
              ('ss', False, 1, lambda i: all[i,10],),
              ('sn', False, 1, lambda i: all[i,11],),              
              ('e' , False, 3, lambda i: all[i,12:15],),
              ('s' , False, 3, lambda i: all[i,15:18],),
              ('d' , False, 1, lambda i: all[i,18],),
              ('rt', False, 1, lambda i: all[i,19],),
              ('rn', False, 1, lambda i: all[i,20],),
              ('mat', False, 1, lambda i: all[i,21],),                             
