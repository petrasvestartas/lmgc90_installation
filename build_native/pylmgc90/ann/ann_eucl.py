...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_ann_eucl')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_ann_eucl')
    _ann_eucl = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ann_eucl', [dirname(__file__)])
        except ImportError:
            import _ann_eucl
            return _ann_eucl
        try:
            _mod = imp.load_module('_ann_eucl', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
kdtree_swigregister = _ann_eucl.kdtree_swigregister
