...
cube1.imposeDrivenDof(group='up',component=[3], dofty='vlocy',description='evolution',evolutionFile='vz.dat')
bodies += cube1
...
mat_file = 'pierre_mod.mat'
shutil.copyfile(mat_file,datbox/mat_file)
  
dt=1e-1

epc0=1.3*(30.e6/30.e9)
du=0.1*epc0/52.

print(du)


f=open('./DATBOX/vz.dat','w')
t=0.
f.write('%12.5e %12.5e\n' % ( t   ,  0.))
t=t+1.
f.write('%12.5e %12.5e\n' % ( t   , 0.))
