...
while chipy.TimeEvolution_GetTime() < t_final :
  ...
  # Number of step in which the displacement returns to zero (u_z=0)
  nbs_1 = 241 
  nbs_2 = 521

  # Temperature imposed
  T_01 = 20.
  T_1 = T_01*np.ones(chipy.mecaMAILx_GetNbNodes(1))
  T_02 = 500.
  T_2 = T_02*np.ones(chipy.mecaMAILx_GetNbNodes(1))
  T_03 = 1000.
  T_3 = T_03*np.ones(chipy.mecaMAILx_GetNbNodes(1))
  
  if chipy.TimeEvolution_GetTime() < nbs_2:
    if chipy.TimeEvolution_GetTime() < nbs_1:
     chipy.mecaMAILx_SetScalarFieldByNode(1,1,T_1)
     display_T.append(T_1)
    else:
     chipy.mecaMAILx_SetScalarFieldByNode(1,1,T_2)
     display_T.append(T_2)
  else:
   chipy.mecaMAILx_SetScalarFieldByNode(1,1,T_3)
   display_T.append(T_3)
