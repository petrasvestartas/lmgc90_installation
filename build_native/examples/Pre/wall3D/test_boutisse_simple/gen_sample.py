...
# on declare un nouveau mur, avec apareil en boutisse simple, constitue de
# briques de Paris
wall = pre.paneresse_simple(brick_ref=brique_Paris, disposition="boutisse")
...
floor = pre.rigidPlan(axe1=1.25, axe2=0.15, axe3=0.03, center=[1.15, 0.11, -0.03],
