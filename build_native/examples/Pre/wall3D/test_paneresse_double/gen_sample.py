...
# on declare un nouveau mur, avec apareil en paneresse double, constitue de
# briques de Paris
wall = pre.paneresse_double(brick_ref=brique_Paris, disposition="paneresse")
...
bodies = wall.buildRigidWall(origin=[0., 0., 0.], model=mod3D, material=plex, colors=['BLEUx', 'REDxx', 'JAUNE', 'VERTx'])

# ajout d'une fondation rigide, i.e. faite d'un plan :

# on declare un corps pour la fondation
floor = pre.rigidPlan(axe1=1.25, axe2=0.25, axe3=0.03, center=[1.15, 0.11, -0.03],
...
svbrbr = pre.see_table(CorpsCandidat   ='RBDY3', candidat   ='POLYR', colorCandidat   ='REDxx',
                       ...
                       behav=lprpr,  alert=0.02)
svs += svbrbr
svbjbj = pre.see_table(CorpsCandidat   ='RBDY3', candidat   ='POLYR', colorCandidat   ='JAUNE',
                       CorpsAntagoniste='RBDY3', antagoniste='POLYR', colorAntagoniste='JAUNE',
                       behav=lprpr,  alert=0.02)
svs += svbjbj
svbvbv = pre.see_table(CorpsCandidat   ='RBDY3', candidat   ='POLYR', colorCandidat   ='VERTx',
...
svbbbr = pre.see_table(CorpsCandidat   ='RBDY3', candidat   ='POLYR', colorCandidat   ='BLEUx',
                       ...
                       behav=lprpr,  alert=0.02)
svs += svbbbr
svbbbj = pre.see_table(CorpsCandidat   ='RBDY3', candidat   ='POLYR', colorCandidat   ='BLEUx',
                       CorpsAntagoniste='RBDY3', antagoniste='POLYR', colorAntagoniste='JAUNE',
                       behav=lprpr,  alert=0.02)
svs += svbbbj
svbjbv = pre.see_table(CorpsCandidat   ='RBDY3', candidat   ='POLYR', colorCandidat   ='JAUNE',
                       CorpsAntagoniste='RBDY3', antagoniste='POLYR', colorAntagoniste='VERTx',
                       behav=lprpr,  alert=0.02)
svs += svbjbv
svbvbr = pre.see_table(CorpsCandidat   ='RBDY3', candidat   ='POLYR', colorCandidat   ='VERTx',
                       CorpsAntagoniste='RBDY3', antagoniste='POLYR', colorAntagoniste='REDxx',
                       behav=lprpr,  alert=0.02)
svs += svbvbr
#       - avec la fondation
svbbpl = pre.see_table(CorpsCandidat   ='RBDY3', candidat   ='POLYR', colorCandidat   ='BLEUx',
                       CorpsAntagoniste='RBDY3', antagoniste='PLANx', colorAntagoniste='WALLx',
                       behav=lprpl,  alert=0.02)
svs += svbbpl
svbrpl = pre.see_table(CorpsCandidat   ='RBDY3', candidat   ='POLYR', colorCandidat   ='REDxx',
                       CorpsAntagoniste='RBDY3', antagoniste='PLANx', colorAntagoniste='WALLx',
                       behav=lprpl,  alert=0.02)
svs += svbrpl
