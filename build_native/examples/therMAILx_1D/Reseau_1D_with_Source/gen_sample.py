...
Model_Thermique = pre.model(name='DIFFU',                           # Key to find the model 
                            ...
                            element='S2xth',                       # Possible elements T6xxx,H8xxx, H20Rx, TE4xx
                            dimension = dimension,
                            external_model='no___', 
                            capacity_storage='lump_',
                            formulation = 'class',
                            external_fields = ['COCO','SPHV','SECTION','SOURCE'])
...
Mailx = pre.readMesh('MESH/Reseau3D_decimate_50.msh', dimension, keep_elements=[1])
...
Barre3D.defineModel(model=Model_Thermique)
# Apply material behaviour on physical groups 31
Barre3D.defineMaterial(material=Mat_1)
# And save this bodies in the pack of bodies
bodies += Barre3D
# ------------------------------------------------------
# Apply the boundary conditions on physical groups
# Imposed a nil flux on the surface 30 (lateral surface)
Barre3D.imposeDrivenDof(group='30', component = 1, dofty='flux', ct = 0.0, rampi = 1.0)
# Imposed a constant temperature on the surface 29 at 0K
Barre3D.imposeDrivenDof(group='29', component = 1, dofty='flux', ct = 0.0, rampi = 1.0)
# Imposed a constant temperature on the surface 28 at 1K
Barre3D.imposeDrivenDof(group='28', component = 1, dofty='temp', ct = 0.0, rampi = 1.0)
# ------------------------------------------------------
# Apply the initial conditions on physical groups
# Imposed initial temperature on the bodies at 0K
Barre3D.imposeInitValue(group='31', component = 1, value = 0.0)
# ------------------------------------------------------
