...
m3Dl = pre.model(name='M3D__', physics='MECAx', element='H8xxx', dimension=3, 
...
mesh_cube   = pre.readMesh('gmsh/cube_h8.msh', dim)
...
cube.imposeDrivenDof(group='102',component=[1, 2, 3], dofty='vlocy')
bodies += cube
...
floor.translate(dx=-0.25, dy=-0.25, dz=-0.2)
...
svcspr = pre.see_table(CorpsCandidat='MAILx', candidat='CSxxx', colorCandidat='BLEUx',
                       ...
                       behav=lcspr, alert=0.01, halo=1.5)
svs+=svcspr
