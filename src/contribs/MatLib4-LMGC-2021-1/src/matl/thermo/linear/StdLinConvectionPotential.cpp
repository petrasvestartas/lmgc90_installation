/*
 *  $Id: StdLinConvectionPotential.cpp 138 2013-08-30 15:25:50Z lstainier $
 *
 ...
 */
#include "StdLinConvectionPotential.h"
...
/*
 * Methods for class StdLinConvectionPotential.
 */

// check consistency of material properties
void StdLinConvectionPotential::checkProperties(MaterialProperties& material,
                                                std::ostream* os) 
 throw (InvalidPropertyException, NoSuchPropertyException) {
  if (os) (*os) << "\n\t***Linearized variational convection model***" << std::endl;
...
// compute 
double StdLinConvectionPotential::diffusionEnergy(const MaterialProperties& material,
                                                  const ParameterSet& extPar,
                                                  double dT,double Th,double& q,
...
/*
 * Methods for class StdLinVariationalConductionBuilder.
 */

// the instance
StdLinVariationalConvectionBuilder const* StdLinVariationalConvectionBuilder::BUILDER 
= new StdLinVariationalConvectionBuilder();

// constructor
StdLinVariationalConvectionBuilder::StdLinVariationalConvectionBuilder() {
  ModelDictionary::add("LINEAR_VARIATIONAL_CONVECTION",*this);
}

// build model
ConstitutiveModel* StdLinVariationalConvectionBuilder::build(unsigned int d) const {
  switch(d) {
    case 3:
    case 2:
    case 1:
      return new StdLinVariationalConvection();
      break;
    default:
      return 0;
      break;
