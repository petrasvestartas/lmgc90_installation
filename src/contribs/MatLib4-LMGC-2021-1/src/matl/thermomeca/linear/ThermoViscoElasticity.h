/*
 *  $Id: ThermoViscoElasticity.h 269 2020-04-09 17:36:12Z lstainier $
 *
  ...
  double incrementalPotential(const MaterialProperties& material,
   ...
   throw (UpdateFailedException) {
    ...
    if (viscous && dTime > 0.0e0) {
      ...
      Dv1 = dTime*viscous->dissipatedThMEnergy(material,extPar,eps,epsDot,Th0,
                                               Sv1a,Sv2a,Nv3,Mv11a,Mv22a,Mv12a,
                                               dSv1,dSv2,Cv3,dTime,
                                               update,tangent);
      Dv2 = dTime*viscous->dissipatedThMEnergy(material,extPar,eps,epsDot,Th,
 ...
 */
template <class ALG>
class ThermoViscoElasticity<ALG>::ViscousPotential : virtual public ViscoElasticity<ALG>::ViscousPotential {
  ...
  double incrementalPotential(const MaterialProperties& material,
   ...
   throw (UpdateFailedException) {
    ...
    if (dTime > 0.0e0) {
      ...
      Wv1 = dTime*viscous->dissipatedThMEnergy(material,extPar,epsV,epsVDot,Th0,
                                               Sv1a,Sv2a,Nv,Mv11a,Mv22a,Mv12a,
                                               dSv1,dSv2,Cv2,
                                               dTime,first,update || second);
      Wv2 = dTime*viscous->dissipatedThMEnergy(material,extPar,epsV,epsVDot,Th,
