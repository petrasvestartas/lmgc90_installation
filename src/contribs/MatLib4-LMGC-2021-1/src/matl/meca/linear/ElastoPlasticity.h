/*
 *  $Id: ElastoPlasticity.h 129 2013-04-05 05:15:49Z lstainier $
 *
 ...
 */
#ifndef ZORGLIB_MATL_MECA_LINEAR_ELASTOPLASTICITY_H
#define ZORGLIB_MATL_MECA_LINEAR_ELASTOPLASTICITY_H
...
/**
 * Base class for (geometrically linear) elastic-plastic material models.
 */
template <class ALG>
class ElastoPlasticity : virtual public Elasticity<ALG> {
 ...
 protected:
  ...
  // copy constructor
  ElastoPlasticity(const ElastoPlasticity&) {}

 public:

  // destructor
  virtual ~ElastoPlasticity() {}
