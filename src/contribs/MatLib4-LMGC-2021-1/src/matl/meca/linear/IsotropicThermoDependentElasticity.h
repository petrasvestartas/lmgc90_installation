/*
 *  $Id: IsotropicThermoDependentElasticity.h 269 2020-04-09 17:36:12Z lstainier $
 *
...
class IsotropicThermoDependentElasticity3D : public Elasticity<TensorAlgebra3D> {
 ...
 public:
  ...
  // copy constructor
  IsotropicThermoDependentElasticity3D(const IsotropicThermoDependentElasticity3D& src)
...
class IsotropicThermoDependentElasticity2D : public Elasticity<TensorAlgebra2D> {
 ...
 public:
  ...
  // copy constructor
  IsotropicThermoDependentElasticity2D(const IsotropicThermoDependentElasticity2D& src)
...
class IsotropicThermoDependentElasticity1D : public Elasticity<TensorAlgebra1D> {
 ...
 public:
  ...
  // copy constructor
  IsotropicThermoDependentElasticity1D(const IsotropicThermoDependentElasticity1D& src)
