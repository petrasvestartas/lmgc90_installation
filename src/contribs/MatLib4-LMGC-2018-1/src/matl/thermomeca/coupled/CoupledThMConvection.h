/*
 *  $Id: CoupledThMConvection.h 138 2013-08-30 15:25:50Z lstainier $
 *
 ...
 */
#ifndef ZORGLIB_MATL_MECA_COUPLED_THERMO_MECHANICAL_CONVECTION_H
#define ZORGLIB_MATL_MECA_COUPLED_THERMO_MECHANICAL_CONVECTION_H
 ...
 */
class CoupledThMConvection : virtual public StandardMaterial {
 ...
 protected:
  ...
  // empty constructor
  CoupledThMConvection(ConvectionPotential* = 0);

 public:

  // constructor
  CoupledThMConvection(ConvectionPotential&);

  // copy constructor
  CoupledThMConvection(const CoupledThMConvection&);

  // destructor
  virtual ~CoupledThMConvection();
...
/**
 * Base class for (non-linear) thermomechanical convection potentials.
 */
class CoupledThMConvection::ConvectionPotential {
