/*
 *  $Id: StdThermalCapacity.cpp 160 2015-03-20 08:49:53Z lstainier $
 *
...
// compute 
double StdThermalCapacity::internalEnergy(const MaterialProperties& material,
                                          const ParameterSet& extPar,
                                          double T,double& N,double& C,
  ...
  double val = Cv*std::log(T/T0);
  double W = Cv*(T-T0)-T*val;
