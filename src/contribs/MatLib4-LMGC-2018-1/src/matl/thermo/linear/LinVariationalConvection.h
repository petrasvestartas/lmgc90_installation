/*
 *  $Id: LinVariationalConvection.h 138 2013-08-30 15:25:50Z lstainier $
 *
 ...
 */
#ifndef ZORGLIB_MATL_THERMO_LINEAR_VARIATIONAL_CONVECTION_H
#define ZORGLIB_MATL_THERMO_LINEAR_VARIATIONAL_CONVECTION_H
...
/**
 * Base class for (linearized) variational convection models.
 */
class LinVariationalConvection : virtual public StandardMaterial {
 ...
 protected:
  ...
  // empty constructor
  LinVariationalConvection(ConvectionPotential* = 0);

 public:

  // constructor
  LinVariationalConvection(ConvectionPotential&);
  
  // copy constructor
  LinVariationalConvection(const LinVariationalConvection&);
  
  // destructor
  virtual ~LinVariationalConvection();
...
/**
 * Base class for (linearized) convection potentials.
 */
class LinVariationalConvection::ConvectionPotential {
